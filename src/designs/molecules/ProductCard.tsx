...
const ProductCard: React.FC<ProductCardProps> = ({ imageSrc, productName }) => (
  <div className="flex flex-col items-center bg-white p-4 shadow-lg rounded-lg space-y-4 w-80">
    {" "}
    {/* Adjusted for shadow and spacing */}
    <ImageAtom
      src={imageSrc}
      alt={productName}
    ...
    />
    <h3 className="text-xl font-semibold text-center">{productName}</h3>{" "}
