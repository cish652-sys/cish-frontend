...
const supportedStartups = [
  { sr: "1.", name: "M/s Parashar Agrotech Bio Pvt. Ltd., Varanasi, U.P.", tech: "Insect Trap Tech." },
  { sr: "2.", name: "M/s Life Speaks, Sangli, Maharashtra", tech: "Insect Trap Tech." },
  { sr: "3.", name: "M/s Ranaji Biotech India Private Limited, Kanpur, U.P.", tech: "Insect Trap Tech." },
  ...
  { sr: "6.", name: "M/s Global Biotech & Agro Solutions, Lucknow, U.P.", tech: "Tissue Culture Tech." },
  { sr: "7.", name: "M/s Apna Gaon Bioenergy Farmer Producer Co. Ltd., Ayodhya, U.P.", tech: "RTF Mushroom Tech." },
  ...
  { sr: "12.", name: "M/s Vishvaksenah Agro and Dairy Pvt Ltd., Muzaffarpur, Bihar", tech: "Value Addition" },
  { sr: "13.", name: "M/s Jaishri Nursery, Varanasi, U.P.", tech: "High-tech Fruit Plants Nursery" },
  { sr: "14.", name: "M/s Mango Baba, Lucknow, U.P.", tech: "Digital Supply Chain" },
  { sr: "15.", name: "M/s Avakar EnviroSource Private Ltd., Lucknow, U.P.", tech: "Organic Farming Tech." },
];
      ...
      <section className="w-full px-4 md:px-8 lg:px-16 py-12 bg-white">
        <div className="container max-w-4xl mx-auto flex flex-col gap-8">
          <h2 className="text-gray-700">
            ICAR-CISH, Lucknow is facilitating incubation to new
            startups/entrepreneurs & enterprises for innovative technologies by
            providing need based physical, technical, business and networking
            support, facilities and services to test and validate their venture
            before successful establishment of enterprises. At CISH-ABI,
            entrepreneurs will be able to transform their ideas into real
            businesses. The business incubation centre of CISH is a one point
            solution for entrepreneurs and enterprises in horticulture.
          </h2>
          ...
          <div className="flex flex-col gap-4">
            <h2 className="text-gray-700">
              <span className="font-semibold">Technological mentoring:</span>{" "}
              Scientists working in ICAR-CISH provide mentorship to the
              entrepreneurs in their respective areas of expertise during
              incubation period at the institute. Mentors help in ideation,
              prototype development, product refinement and pilot scale up
              gradation etc.
            </h2>
            <h2 className="text-gray-700">
              <span className="font-semibold">Capacity building and training:</span>{" "}
              ICAR-CISH has well developed laboratories and infrastructure for
              conducting hands on training on horticulture based technologies.
              Institute frequently conducts several workshops, panel discussion
              and lectures etc. by the eminent experts for imparting and
              building the capacity of knowledge.
            </h2>
            <h2 className="text-gray-700">
              <span className="font-semibold">Branding and promotion:</span>{" "}
              Startups are mentored and facilitated for the branding and
              promotion of their products through several tools and platforms.
            </h2>
          </div>
        </div>
      </section>
      ...
      <section className="w-full px-4 md:px-8 lg:px-16 py-12 bg-[#FBFAF0]">
        <div className="container max-w-4xl mx-auto flex flex-col gap-4">
          <h2 className="text-green-800 font-bold">
            IN-HOUSE INCUBATION FACILITIES:
          </h2>
          <ol
            type="a"
            className="list-lower-alpha list-outside pl-5 flex flex-col gap-2"
          >
             <li>
          ...
          <div className="overflow-x-auto shadow-lg border border-gray-300">
            <table className="w-full border-collapse">
              <thead className="bg-lime-200">
                <tr>
                  <th className="p-3 text-left font-semibold text-gray-800 border-b border-gray-300">Sr. No.</th>
                  <th className="p-3 text-left font-semibold text-gray-800 border-b border-gray-300">Name of Startups / Enterprises / FPO</th>
                  <th className="p-3 text-left font-semibold text-gray-800 border-b border-gray-300">Technology</th>
                </tr>
              </thead>
              <tbody>
                {supportedStartups.map((item, index) => (
                  ...
                  >
                    <td className="p-3 border-t border-gray-300"><h2 className="text-gray-700">{item.sr}</h2></td>
                    <td className="p-3 border-t border-gray-300"><h2 className="text-gray-700">{item.name}</h2></td>
                    <td className="p-3 border-t border-gray-300"><h2 className="text-gray-700">{item.tech}</h2></td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      <section className="w-full px-4 md:px-8 lg:px-16 py-12 bg-[#FBFAF0]">
        <div className="container max-w-4xl mx-auto flex flex-col gap-6">
          ...
          <div>
            ...
            <ul className="list-disc list-outside pl-5 flex flex-col gap-2">
              <li><h2 className="text-gray-700">Self-motivated person with novel and innovative ideas of entrepreneurship in Horticulture.</h2></li>
              <li><h2 className="text-gray-700">Anyone having meaningful and viable idea with sustainable development.</h2></li>
              <li><h2 className="text-gray-700">A person who has large canvas of vision for his startup.</h2></li>
              <li><h2 className="text-gray-700">A courageous who dream to make it possible.</h2></li>
              <li><h2 className="text-gray-700">Risk takers to conquer the challenges.</h2></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <h2 className="text-gray-700">Website: http://cish.org.in/, https://cish.org.in/abi_n.php</h2>
          </div>
