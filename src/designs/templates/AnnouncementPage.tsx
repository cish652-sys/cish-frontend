...
const allAnnouncementsData: TableRow[] = [
  {
    ...
    publishedDate: "04-09-2025",
    fileSize: "1.99 MB",
    viewUrl: "/announcements/foundation-day.pdf",
  },
  {
    title: "New Tender Posted",
    publishedDate: "02-09-2025",
    fileSize: "0.50 MB",
    viewUrl: "/announcements/tender-01.pdf",
  },
  // ... (rest of your dummy data)
  {
    title: "Training Workshop",
    publishedDate: "18-08-2025",
    fileSize: "0.80 MB",
    viewUrl: "/announcements/workshop.pdf",
  },
  {
    title: "Procurement Notice",
    publishedDate: "15-08-2025",
    fileSize: "0.60 MB",
    viewUrl: "/announcements/procurement.pdf",
  },
];
...
const AnnouncementPage = () => {
  ...
  useEffect(() => {
    const fetchAndSetData = async () => {
      try {
        setIsLoading(true);
        setIsError(false);
        const { data } = await axios.get<ApiAnnouncementItem[]>(
          "https://api.cish.org.in/api/content/keyOfferingsAnnouncement"
        );
  ...
  // 6. Fallback logic
  const dataToProcess =
    !isLoading && !isError && apiData.length > 0 ? apiData : allAnnouncementsData;
  ...
  return (
    <main>
      ...
      <SectionHeader
        breadcrumbItems={[{ label: "Home", href: "/" }, { label: "ANNOUNCEMENTS" }]}
        iconProps={true}
        title="ANNOUNCEMENTS"
        description={[""]}
      />
