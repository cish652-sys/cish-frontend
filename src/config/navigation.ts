...
export const navigation: NavItem[] = [
...

  {
    ...
    links: [
      ...
      { href: "/about/itmu-ipr", label: "ITMU/IPR Cells" },
      { href: "/about/abi", label: "Agri Business Incubation Center (ABI)" },
      { href: "/about/akmu", label: "AKMU" },
      { href: "/about/rural-station", label: "Regional Research Station" },
      { href: "/about/kvk", label: "Krishi Vigyan Kendra" },
      { href: "/about/cadrer", label: "Cadre Strength" },
