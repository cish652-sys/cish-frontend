...
export const navigation: NavItem[] = [
...

  {
    ...
    links: [
      ...
      { href: "https://cish.org.in/abi_n.php", label: "Agri Business Incubation Center (ABI)" },
      { href: "/about/akmu", label: "AKMU" },
      { href: "/https://cish.org.in/malda_n.php", label: "Regional Research Station" },
      { href: "https://cish.org.in/krishi-portal.php", label: "Krishi Vigyan Kendra" },
